...
export function QuickAdd({onSelect}:{onSelect:(v:string)=>void}){
 ...
 const opts=[['task','☑️ Task'],['work','📅 Appuntamento lavoro'],['personal','👤 Appuntamento personale'],['content','📹 Contenuto'],['idea','💡 Idea'],['script','📝 Script'],['lead','🎯 Lead'],['payment','💰 Pagamento'],['client','👥 Cliente']];
