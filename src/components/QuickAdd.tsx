...
const actions=[
  ...
  {key:'personal',title:'Personale',desc:'Proteggi un impegno privato',icon:Users,tone:'neutral'},
  ...
  {key:'payment',title:'Pagamento',desc:'Registra una scadenza',icon:CircleDollarSign,tone:'dark'},
