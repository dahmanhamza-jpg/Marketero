...
export function QuickAdd({onSelect}:{onSelect:(v:string)=>void}){
 ...
 const opts=[['task','☑️ Task'],['work','📅 Appuntamento lavoro'],['personal','👤 Appuntamento personale'],['script','📝 Script / contenuto'],['idea','💡 Idea'],['lead','🎯 Lead'],['payment','💰 Pagamento'],['client','👥 Cliente']];
