...
export interface CalendarEvent extends BaseEntity {
  clientId?:string; title:string; kind:EventKind; category:string; startAt:string; endAt?:string; allDay?:boolean; notes?:string;
}
...
export interface Settings extends BaseEntity {
  ...
  darkMode:boolean; syncToken?:string; userName?:string; dateFormat?:'it-IT'|'en-GB';
  calendarView?:CalendarView; notificationsEnabled?:boolean; notificationDeadlines?:boolean;
  notificationAppointments?:boolean; notificationClients?:boolean; notificationReminders?:boolean;
